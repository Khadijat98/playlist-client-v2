...
const RegisterErrorDialogBox = (props) => {
                ...
                <div>
                  ...
                  <div className="mt-2">
                    <p className="text-base text-gray-500 text-center">
                      Sorry, it looks like this email has already been used.
                      Please log in or try again with a different email address.
                    </p>
                  </div>
                </div>
                <div className="mt-5">
...
export default RegisterErrorDialogBox;
